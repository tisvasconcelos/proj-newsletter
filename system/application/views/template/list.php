    		...
    		<div class="center">
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					<tbody>
						...
						<tr>
							<td><a href="<?=site_url('template/edit/'.$t->so_id)?>"><?=$t->tpd_name?></a></td>
							<td>
								<a href="<?=site_url('template/edit/'.$t->so_id)?>" class="edit" title="<?=$this->lang->line('interface_edit')?>"><?=$this->lang->line('interface_edit')?></a>
								<a href="<?=site_url('template/delete/'.$t->so_id)?>" class="delete" title="<?=$this->lang->line('interface_delete')?>"><?=$this->lang->line('interface_delete')?></a>
							</td>
						</tr>
							<?}
						}else{?>
				...
				<a class="new" href="<?=site_url('template/edit')?>" title="<?=$this->lang->line('interface_new')?>"><?=$this->lang->line('interface_new')?></a>
	    	</div>
    	</div>
